...
io.on('connection', (socket) => {
    ...
    /*To collect message and insert into database*/
    socket.on('chatMessage', (data) =>{ /*recieves message from client-end with sender's and reciever's details*/
    ...
    socket.on('userDetails',(data) => { /*To checks if a new user has logged in and recieves the established chat details*/
        mongoClient.connect(database, (err,db) => {
            if(err)
                throw err;
            else {
